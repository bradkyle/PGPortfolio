...
import numpy as np
import datetime
from axiom.tools.indicator import max_drawdown, sharpe, positive_count, negative_count, moving_accumulate
from axiom.tools.configprocess import parse_time, check_input_same
...
def plot_backtest(config, algos, labels=None):
    ...
    @:param algos: list of strings representing the name of algorithms or index of axiom result
    """
    results = []
