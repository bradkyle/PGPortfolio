...
function handlerSetup(client, config, logger) {
    ...
    request, additionalMessage, callback) {
        var em;
        if (is_1.default.string(request)) {
            // no request given
            callback = additionalMessage;
            additionalMessage = request;
            request = undefined;
        }
        else if (is_1.default.function(request)) {
            // neither request nor additionalMessage given
            callback = request;
            request = undefined;
            additionalMessage = undefined;
        }
        if (is_1.default.function(additionalMessage)) {
            callback = additionalMessage;
            additionalMessage = undefined;
        }
