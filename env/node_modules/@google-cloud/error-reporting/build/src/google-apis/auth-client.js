...
var RequestHandler = /** @class */ (function (_super) {
    ...
    function RequestHandler(config, logger) {
        ...
        var serviceOptions = Object.assign(config, {
        ...
        var that = _this;
        if (tryAuthenticate) {
            _this.authClient.getAccessToken().then(function () { }, function (err) {
                that._logger.error([
    ...
    RequestHandler.prototype.sendError = function (errorMessage, userCb) {
        var _this = this;
        var cb = (is_1.default.function(userCb) ? userCb : RequestHandler.noOp);
