...
var isBoolean = is_1.default.boolean;
var isString = is_1.default.string;
var isNumber = is_1.default.number;
var env = process.env;
/**
...
var Configuration = /** @class */ (function () {
    ...
    Configuration.prototype._checkLocalServiceContext = function () {
        ...
        if (isObject(this._givenConfiguration.serviceContext)) {
            ...
            else if (lodash_has_1.default(this._givenConfiguration.serviceContext, 'service')) {
            ...
            else if (lodash_has_1.default(this._givenConfiguration.serviceContext, 'version')) {
    ...
    Configuration.prototype._gatherLocalConfiguration = function () {
        ...
        else if (lodash_has_1.default(this._givenConfiguration, 'ignoreEnvironmentCheck') &&
        ...
        else if (lodash_has_1.default(this._givenConfiguration, 'key')) {
        ...
        else if (lodash_has_1.default(this._givenConfiguration, 'keyFilename')) {
        ...
        else if (lodash_has_1.default(this._givenConfiguration, 'credentials')) {
        ...
        else if (lodash_has_1.default(this._givenConfiguration, 'reportUnhandledRejections')) {
    ...
    Configuration.prototype._checkLocalProjectId = function () {
        ...
        if (lodash_has_1.default(this._givenConfiguration, 'projectId')) {
