...
export declare class ErrorReporting {
    ...
    private _config;
    private _client;
    report: (err: any, // tslint:disable-line:no-any
    request?: manualRequestExtractor.Request, additionalMessage?: string | {}, callback?: manualInterface.Callback | {} | string) => ErrorMessage;
    event: () => ErrorMessage;
    hapi: {
