...
import numpy as np
import pandas as pd
from pgportfolio.tools.data import panel_fillna, frame_fillna
...
class HistoryManager:
    ...
    def __init__(self, coin_number, end, volume_average_days=1, volume_forward=0, online=True, table="History"):
    ...
    def initialize_db(self,table):
        with sqlite3.connect(SQLITE_DATABASE_DIR) as connection:
    ...
    def get_global_panel(self, start, end, period=300, features=('close',)):
        ...
        connection = sqlite3.connect(SQLITE_DATABASE_DIR)
        try:
